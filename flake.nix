      ...
      release = {
        ...
        assets = {
          x86_64-linux = {
            ...
            hash = "sha256-oEuHLhE+3xLIS3rZZc8O6pDLyfE/ec3IXe0oYRSw0ls=";
          };
          aarch64-linux = {
            target = "aarch64-unknown-linux-gnu";
            hash = "sha256-SX8aYABf7wgft57w7VdOUlfRvtHlv3U4b8H9G4ZX7Qo=";
          };
          aarch64-darwin = {
            target = "macos";
            hash = "sha256-1jG5tXRL/ApDVEtkVvGr+L2JMGfA5sEDzsvhQcmyGV0=";
          };
        };
      };
    in
